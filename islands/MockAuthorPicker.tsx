...
interface MockAuthorPickerProps {
    authors: MockAuthor[]
    selectedAuthor: MockAuthor | null
    onSelect(author: MockAuthor): void
}

export default function MockAuthorPicker({ authors, selectedAuthor, onSelect }: MockAuthorPickerProps) {
    ...
    function selectAuthor(author: MockAuthor) {
        onSelect(author)
        setSearch("")
        setIsOpen(false)
    }
