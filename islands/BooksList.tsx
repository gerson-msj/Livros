    ...
    return (
        <button class="livros-book-item" type="button" onClick={() => onSelect(book)}>
            ...
            <span class="livros-book-item-dates">
                <BookDate label="Inicio" value={formatDate(book.readingStartedOn)} />
                <BookDate label="Conclusao" value={formatDate(book.readingFinishedOn)} />
            </span>
...
function EmptyBooksState({ onNewBook }: { onNewBook: () => void }) {
    return (
        <div class="livros-books-empty">
            ...
            <p class="has-text-grey">Use o botao de inclusao para cadastrar o primeiro livro.</p>
